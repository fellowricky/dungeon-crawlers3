...
export const MONSTERS = {
  1: [
    { name:'Giant Rat', ac:12, hp:[2,6],  atk:4, dmg:[1,4,2],  xp:15,  color:0x8a7a6a, scale:0.6, speed:3.4, sprite:'animals/rat.png' },
    { name:'Grey Rat', ac:11, hp:[1,6],  atk:3, dmg:[1,4,1],  xp:10,  color:0x7a7a7a, scale:0.55, speed:3.6, sprite:'animals/grey_rat.png' },
    { name:'Giant Bat', ac:13, hp:[1,8],  atk:4, dmg:[1,4,1],  xp:12,  color:0x5a4a3a, scale:0.7, speed:3.8, sprite:'animals/giant_bat.png' },
    { name:'Goblin',    ac:15, hp:[2,6],  atk:4, dmg:[1,6,2],  xp:30,  color:0x6a8a4a, scale:0.75, speed:3.2, sprite:'goblin.png' },
    { name:'Skeleton',  ac:13, hp:[2,8],  atk:4, dmg:[1,6,2],  xp:30,  color:0xcabfa8, scale:0.85, speed:3.0, sprite:'undead/skeletons/skeleton_humanoid_large.png' },
    { name:'Zombie',    ac:8,  hp:[3,8],  atk:3, dmg:[1,6,1],  xp:30,  color:0x5a7a5a, scale:0.9, speed:2.0, sprite:'undead/ghoul.png' },
    { name:'Giant Centipede', ac:12, hp:[2,6], atk:4, dmg:[1,4,2], xp:18, color:0xaa5a3a, scale:0.7, speed:3.2, sprite:'animals/giant_centipede.png' },
    { name:'Adder', ac:13, hp:[1,8], atk:4, dmg:[1,4,1], xp:15, color:0x3a8a3a, scale:0.6, speed:3.5, sprite:'animals/adder.png' }
  ],
  2: [
    { name:'Orc',        ac:13, hp:[2,8,6],  atk:5, dmg:[1,12,3], xp:70, color:0x4a6a3a, scale:0.95, speed:3.2, sprite:'orc.png' },
    { name:'Gnoll',      ac:14, hp:[3,8,3],  atk:4, dmg:[1,8,2],  xp:70, color:0x8a6a4a, scale:0.95, speed:3.1, sprite:'gnoll.png' },
    { name:'Hobgoblin',  ac:18, hp:[2,8,2],  atk:3, dmg:[1,8,1],  xp:70, color:0x9a5a3a, scale:0.9, speed:3.0, sprite:'hobgoblin.png' },
    { name:'Giant Spider',ac:14, hp:[4,8,4], atk:5, dmg:[1,8,3],  xp:140, color:0x3a3a4a, scale:0.9, speed:3.6, sprite:'animals/spider.png' },
    { name:'Wolf Spider', ac:14, hp:[5,8,5], atk:5, dmg:[1,8,4],  xp:140, color:0x4a4a4a, scale:0.95, speed:3.7, sprite:'animals/wolf_spider.png' },
    { name:'Ghoul',      ac:12, hp:[5,8],    atk:4, dmg:[2,6,2],  xp:140, color:0x7a8a6a, speed:3.2, scale:0.9, sprite:'undead/ghoul.png' },
    { name:'Mummy',      ac:11, hp:[4,8,8],  atk:4, dmg:[1,10,2], xp:105, color:0xdedebe, scale:0.9, speed:2.4, sprite:'undead/mummy.png' },
    { name:'Warg',       ac:13, hp:[4,8,8],  atk:4, dmg:[2,6,1],  xp:105, color:0x5a5a5a, scale:0.9, speed:3.6, sprite:'animals/warg.png' },
    { name:'Crocodile',  ac:15, hp:[3,10,9], atk:4, dmg:[1,10,2], xp:105, color:0x3a5a3a, scale:1.0, speed:2.8, sprite:'animals/crocodile.png' }
  ],
  3: [
    { name:'Bugbear',    ac:16, hp:[5,8,5],   atk:4, dmg:[2,8,2],  xp:150, color:0x8a6a3a, scale:1.1, speed:3.0, sprite:'orc_warrior.png' },
    { name:'Werewolf',   ac:12, hp:[9,8,18],  atk:4, dmg:[2,6,2],  xp:500, color:0x6a5a4a, scale:1.05, speed:3.6, sprite:'shapeshifter.png' },
    { name:'Ogre',       ac:11, hp:[7,10,21], atk:6, dmg:[2,8,4],  xp:340, color:0x9a8a5a, scale:1.35, speed:2.6, sprite:'ogre.png' },
    { name:'Minotaur',   ac:14, hp:[9,10,27], atk:6, dmg:[2,12,4], xp:500, color:0x7a4a3a, scale:1.2, speed:3.2, sprite:'minotaur.png' },
    { name:'Deep Troll', ac:14, hp:[8,10,32], atk:6, dmg:[2,6,4],  xp:500, color:0x3a6a4a, scale:1.35, speed:2.8, sprite:'deep_troll.png' },
    { name:'Manticore',  ac:13, hp:[6,10,12], atk:5, dmg:[2,4,2],  xp:340, color:0xaa6a4a, scale:1.25, speed:3.3, sprite:'manticore.png' },
    { name:'Polar Bear', ac:12, hp:[5,10,20], atk:5, dmg:[2,6,2],  xp:300, color:0xeeeeee, scale:1.2, speed:3.2, sprite:'animals/polar_bear.png' },
    { name:'Wight',      ac:14, hp:[6,8,6],   atk:4, dmg:[1,8,2],  xp:300, color:0x8a9a8a, scale:1.0, speed:2.8, sprite:'undead/wight.png' },
    { name:'Vampire',    ac:15, hp:[8,8,8],   atk:6, dmg:[1,10,3], xp:450, color:0xaaaaff, scale:1.05, speed:3.4, sprite:'undead/vampire.png' }
  ],
  boss: [
    { name:'Ettin',        ac:12, hp:[10,10,30], atk:7, dmg:[2,8,5],  xp:900,  color:0xaa7a4a, scale:1.7, speed:2.6, sprite:'ettin.png' },
    { name:'Young Dragon', ac:17, hp:[11,10,33], atk:7, dmg:[2,10,4], xp:1400, color:0xb04030, scale:1.8, speed:3.2, sprite:'dragons/dragon.png' },
    { name:'Troll',        ac:15, hp:[8,10,40],  atk:7, dmg:[2,6,4],  xp:1400, color:0x4a8a6a, scale:1.6, speed:3.0, sprite:'troll.png' },
    { name:'Stone Giant',  ac:17, hp:[11,12,44], atk:9, dmg:[3,8,6], xp:2300, color:0x8a8a9a, scale:1.9, speed:2.8, sprite:'stone_giant.png' }
  ]
};
...
export function spawnMonster(tier, dungeonLevel, rngPick, allowedNames = null){
  ...
  /* gentle depth scaling — slow enough that hero growth keeps pace,
     keeping floors challenging but not a meat grinder */
  /* +1 base HD, then +1 HD per 4 dungeon levels (was per 2); bosses +1 per ~1.3 levels (was per ~0.7) */
  let hp = roll(spec.hp[0] + 1 + Math.floor(lvlB * (tier==='boss' ? 0.75 : 0.25)), spec.hp[1], spec.hp[2]||0);
  let atk = spec.atk + Math.floor(lvlB / 4);
  /* training-wheels boss: SRD boss blocks are deadly to a level-1 party,
     so the first floor's boss fights at reduced strength */
  if(tier==='boss' && dungeonLevel <= 1){ hp = Math.round(hp * 0.7); atk -= 1; }
  return {
    name: spec.name, ac: spec.ac + Math.floor(lvlB / 5), maxHp: hp, hp,
    atk,
    dmg: spec.dmg, xp: Math.round(spec.xp * Math.min(1.5, 1 + lvlB * 0.12)),
    ...
    gold: Math.round((spec.xp/10) * Math.min(1.6, 1 + lvlB * 0.15) * (0.6+Math.random()*0.8))
  };
}
